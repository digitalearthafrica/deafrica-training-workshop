...
Latest Updates
--------------
 - **29/09/2021:** The WOfS dataset used in Session 6 can now be accessed by its new product name ``wofs_ls``. The session content and demonstration notebook have been updated. The deprecated product ``ga_ls8c_wofs_2`` will slowly be phased out.
